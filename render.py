        ...
        for category, href in all_categories : 
            if category == 'Womens Fiction' : 
                ...
                try : 
                    ...
                    print(f"Vous ne pouvez pas accèder à ce site maitenant à cause {e}, revenez plus tard") 

except EOFError as e : 
    print(f"Vous ne pouvez pas accéder à l'url maintenant pour cause {e}")


get_url_to_scrap('https://books.toscrape.com')
...
# with open('data-live.csv', 'r', encoding='utf-8') as file: 
